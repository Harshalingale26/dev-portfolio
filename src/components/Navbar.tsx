...
import { Linkedin, Twitter, Github, Mail, Menu, X } from 'lucide-react';
...
const Navbar: React.FC = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={20} />, href: 'https://linkedin.com/in/harshal-ingale-50613b258' },
    { icon: <Twitter size={20} />, href: 'https://x.com/harshalingale26' },
    { icon: <Github size={20} />, href: 'https://github.com/Harshalingale26' },
    { icon: <Mail size={20} />, href: 'mailto:harshalingale26@gmail.com' },
  ];
