...
const projects: Project[] = [
  {
    id: 1,
    name: "ExpoCore – Smart Event Management",
    description: "Enterprise-grade multi-tenant event management platform built to streamline the complete event lifecycle, from registrations and ticketing to onsite operations and post-event analytics. Features role-based access control, QR-based attendee check-ins, payment gateway integration, and white-label tenant management.",
    stack: ["React.js", "Node.js", "PostgreSQL", "MongoDB", "AWS Serverless", "Stripe"],
    image: "/images/expocore-brand-hero.png",
    github: "https://github.com/Harshalingale26",
    live: null,
  },
  {
    id: 2,
    name: "LuxeEscape – Premium Travel Booking",
    description: "Premium luxury travel platform designed to deliver immersive travel experiences through curated destinations, luxury accommodations, cruises, private aviation, and personalized itineraries. Built with an enterprise CMS, advanced search and filtering, enquiry management, and SEO-optimized publishing.",
    stack: ["React.js", "Node.js", "PostgreSQL", "CMS", "SEO"],
    image: "/images/luxeescape-brand-hero.png",
    github: "https://github.com/Harshalingale26",
    live: null,
  },
  {
    id: 3,
    name: "PlantMom – Plant Care Platform",
    description: "Community-driven marketing website built for a plant care brand, designed to educate and engage plant enthusiasts. Features a custom 3D hero section, scroll-based animations, a reusable design system, and WhatsApp community integration.",
    stack: ["React.js", "TypeScript", "Vite", "Tailwind CSS", "shadcn/ui"],
    image: "/images/plantmom-brand-hero.png",
    github: "https://github.com/Harshalingale26",
    live: null,
  },
  {
    id: 4,
    name: "EMPIRE – AI Life & Business Simulator",
    description: "AI-powered mobile life and business simulation platform where players create a founder identity, build and scale a business empire, raise and allocate capital, and make dynamic strategic decisions with a premium AAA-inspired user experience.",
    stack: ["React Native", "Expo", "TypeScript", "Node.js", "Express.js"],
    image: "/images/empire-brand-hero.png",
    github: "https://github.com/Harshalingale26",
    live: null,
  },
  {
    id: 5,
    name: "CardVault – AI Business Card Scanner",
    description: "AI-powered business card digitization and lead management platform. Scan cards with OCR, extract contacts using Google Cloud Vision AI, manage event-based leads, and sync through an offline-first architecture with subscription management.",
    stack: ["React Native", "NestJS", "Next.js", "PostgreSQL", "Prisma"],
    image: "/images/cardvault-brand-hero.png",
    github: "https://github.com/Harshalingale26",
    live: null,
  },
];
